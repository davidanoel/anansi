...
public struct UserProfile has drop, store {
...
public fun can_participate(registry: &ComplianceRegistry, user: address): bool {
...
public fun assert_can_participate(registry: &ComplianceRegistry, user: address) {
