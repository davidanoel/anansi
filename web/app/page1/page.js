  ...
  return (
    <>
      ...
      <section className="hero-section hero-grid-bg min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-20 min-h-screen flex flex-col items-center justify-center pt-28 sm:pt-32 md:pt-36 pb-16 md:pb-20 px-6">
          ...
          <div className="animate-fade-up animate-fade-up-delay-1">
            <Image
              ...
              height={821}
              priority
              className="w-[min(84vw,420px)] sm:w-[min(78vw,520px)] md:w-[min(58vw,720px)] h-auto invert opacity-95 drop-shadow-[0_12px_32px_rgba(0,0,0,0.34)]"
            />
          </div>

          <h2 className="max-w-[620px] text-center font-display font-medium text-[clamp(19px,5.4vw,34px)] leading-[1.16] mt-10 sm:mt-11 md:mt-12 text-anansi-gray-300 animate-fade-up animate-fade-up-delay-2">
